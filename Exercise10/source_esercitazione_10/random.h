...
int Check_int(std::vector<int> &v );
void Check_c(std::vector<int> &v );
void Check(std::vector<int> &v );
void Check_s(std::vector<int> &v );
...
std::vector<int> permutation_m (std::vector<int> &v);
...
void order2(std::vector<vector<int>> &pop, int n, vector<double> x, vector<double>y);

std::vector<int> crossover1(std::vector<int> &gen1, std::vector<int> &gen2);
std::vector<int>best_p(std::vector<vector<int>>popolazione);
};
