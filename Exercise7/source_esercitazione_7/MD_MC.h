...
double vtail, ptail, bin_size, nbins, sd, drbin;
double walker[m_props];
double g_glob[2][1000],g_blk[1000];
// averages
double blk_av[m_props], blk_norm, accepted, attempted;
double glob_av[m_props], glob_av2[m_props];
double stima_pot, stima_pressure, stima_kin, stima_etot, stima_temp, stima_g, normal;
